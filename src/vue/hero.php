<div id="canvasWrap" class="canvasWrap">
    ...
    <div id="heroContainer" class="row">
        ...
        <div id="leftContainer" class="d-flex col-sm-11 col-md-8 col-lg-6">
            <div class="contentBannerBox row">
                <h1 class="heroTitle col-12 d-flex align-items-center">J. RENAUD</h1>
                <div class="heroBioContainer col-12 d-flex flex-column">
                    <p class="heroBioText">
                        Je suis cool. Oui c'est moi lalalalalallalalalalala
                        OK Oui Dispo. Je suis cool. Oui c'est moi lalalalalallalalalalala
                        OK Oui Dispo. Je suis cool. Oui c'est moi lalalalalallalalalalala
                        OK Oui Dispo.
                    </p>
        ...
        <div id="midContainer" class="col-sm-1 col-md-1 col-lg-1">
            <div class="btnContainer d-flex flex-sm-column flex-wrap gap-3">
                ...
                <button type="button" id="btn-special3" class="btn"></button>
            </div>
        </div>
        <div id="rightContainer" class="d-none d-md-flex col-md-3 col-lg-5">
