    ...
    <div class="competences conteneurProjet">
        ...
        <div class="competence">
            ...
            <p class="competenceDescription">
                Dans le cadre de projets SAE de première année, j’ai pu participer à la création d’une <b>base de données relationnelle</b> à l’aide du <i>SGBD Oracle</i>, en utilisant l’interface en ligne de commande <i>iSQL*Plus</i>. J’ai su <b>modéliser</b> une base de données à l’aide d’un diagramme entité/association conçu avec le logiciel <i>Looping</i>. J’ai ensuite écrit des <b>scripts SQL</b> pour créer, modifier, insérer et supprimer les données de la base.
                Ces projets m’ont permis de mettre en œuvre les notions fondamentales des bases de données relationnelles, notamment les relations binaires et ternaires, les contraintes d’intégrité (domaines, inclusion, exclusion, fonctionnelles), la notion d'héritage et de clés primaires et étrangères. J’ai également utilisé <i>DBeaver</i>, un outil open source d’administration de base de données, pour importer les données initiales sous forme de tableaux temporaires et faciliter la structuration de la base de données.
            </p>
            ...
            <p class="competenceDescription">
                En parallèle, j’ai manipulé et réalisé des <b>études statistiques</b> sur un jeu de données brutes issues de l’application <i>Spotify</i>, fournies sous forme de fichiers <i>CSV</i>. Ces données ont été transformées et analysées à l’aide du tableur <i>LibreOffice Calc</i>. J’ai utilisé des outils de tri, de regroupement et de calcul pour extraire les modalités, les fréquences, les effectifs, ainsi que des indicateurs statistiques comme la moyenne, la médiane, les quartiles, l’écart-type et l’écart interquartile.
                En fonction de la nature des variables (qualitatives ordinales ou nominales, quantitatives discrètes ou continues), j’ai adapté la <b>restitution visuelle</b> à travers différents supports : tableaux, diagrammes en secteurs, diagrammes en bâtons, histogrammes et boxplots. Ce travail m’a permis de mieux comprendre l’importance de l’organisation des données pour en faciliter l’analyse et la communication.
            </p>
