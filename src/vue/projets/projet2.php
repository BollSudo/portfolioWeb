...
<div class="conteneurProjet">
    ...
    <section>
        ...
        <p class="contentProjet">
            Le développement du site suivait une <b>architecture Modèle Vue Contrôleur (MVC)</b>, n'utilisait aucun framework et avait <b><i>Composer</i></b> comme gestionnaire de dépendances. Le site web intéragit avec une <b>base de donnée <i>MariaDB</i></b>. Le projet était accompagné d'une application de la <b>méthode AGILE SCRUM</b>. Il s'est déroulé en quatre sprints ou itérations (cycle de développement) d'au moins deux semaines pour lesquelles j'ai occupé le rôle de <b>SCRUM Master</b> durant les deux premières itérations. Ma fonction était de veiller à ce que l'équipe applique bien la méthode tout en initiant les rituels tels que les stand-up meetings réguliers, la planification, les réunions d'affinage et les rétrospectives de fin de sprint.
        </p>
        <p class="contentProjet">
            En parallèle, j'ai mobilisé mes compétences techniques pour développer des fonctionnalités clés. Parmi ces dernières, je me suis consacré au développement du <b>système d'importation des données</b> relatives aux dossiers des étudiants. J'ai également travaillé sur l'implémentation d'un <b>système de gestion d'agrégations de notes</b> permettant la génération automatisé des avis de poursuite d'études. Ces implémentations m'ont permis de solidifier mes bases techniques en PHP et SQL : d'une part, via l'implémentation de divers formulaires accompagnées d'une double vérification coté client et coté serveur ; d'autre part, via la <b>conception d'une base de données</b> robuste prêt à accueillir des données tout en assurant leur sécurité et leur confidentialité. La qualité du code est étayé par l'application constante des principes fondamentaux de qualité de développement tels que <b>SOLID, DRY, et KISS</b>. Durant ce projet, j'ai appliqué trois grands patterns de conception justifiés, tels que <b>le Singleton, la Stratégie ou bien la Composite</b>. J'ai aussi mobilisé mes compétences à développer des interfaces utilisateurs tout en respectant les <b>normes d'accessibilités et la responsivité</b>.
        </p>
    </section>
    <section>
