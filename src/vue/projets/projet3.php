...
<div class="conteneurProjet">
    ...
    <section>
        ...
        <p class="contentProjet">
            Dans le cadre d'un projet de trois mois de 1ère année de BUT Informatique, en binôme, nous avons développé une application de bureau en <b>Java</b> qui se présente sous la forme d'un éxecutable. Cette application consiste en une version numérique d'un jeu de plateau nommé <i>Trains ©</i>. L'objectif de ce projet était d'<b>informatiser la mécanique</b> du jeu afin d'<b>implémenter une Interface Homme Machine (IHM) érgonomique</b> en passant par l'<b>exploration des algorithmes de graphes</b>. La structure du projet suit la convention <b>Maven</b>.
        </p>
    </section>
    <section>
